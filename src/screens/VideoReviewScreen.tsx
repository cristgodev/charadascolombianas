...
export const VideoReviewScreen = ({ navigation, route }: any) => {
    ...
    const handleSave = async () => {
        try {
            ...
            Alert.alert(t('success'), "Video guardado en galería.");
        } catch (error: any) {
    ...
    return (
        ...
        >
            <Container centered style={styles.container}>
                ...
                {/* Video Card - Tightly fitted to allow background to show */}
                ...
                {/* Modal remains mostly same but styled for Portrait */}
                <Modal
                    animationType="slide"
                    transparent={true}
...
const styles = StyleSheet.create({
    ...
    controls: {
        ...
        paddingHorizontal: 20,
        width: '100%',
        // Transparent or slightly dark to letting background show?
        // User asked to replace black background, so let's make controls floating or semi-transparent
